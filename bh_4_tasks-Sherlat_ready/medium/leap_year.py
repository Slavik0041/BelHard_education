...
def is_year_leap(year: int) -> bool:
    if year % 4 != 0:
        print('Обычный год! 365 дней')
        return False
    elif year % 4 == 0 and year % 100 != 0:
        print('Не столетие, значит высокосный! 366 дней')
        return True
    elif year % 4 == 0 and year % 100 == 0 and year % 400 == 0:
        print('Делится на 400, значит високосный!')
        return True
    else:
        print('Обычный год, 365 дней! ')
        print('Всю жизнь думал, что каждый 4й год високосный. Мой мир перевернулся)))')
        return False
